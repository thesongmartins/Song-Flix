...
//The hero section of the web app where random movies display.
const Hero = () => {
    ...
    content = (
      <section className="h-full w-full relative">
        ...
        <div className="px-6 lg:px-14 absolute top-24 lg:top-48 flex flex-col gap-6">
          <h1 className="text-white text-4xl font-bold lg:w-[300px]">
            {movie.title}
          </h1>
          ...
          <Link
            to={`movie/${movie.id}`}
            className="flex items-center justify-center p-1 md:p-2 gap-2 bg-[#BE123C] text-white md:w-[150px] rounded"
          >
            <BsPlayCircle />
            Watch trailer
          </Link>
